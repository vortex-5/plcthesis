...
To describe our state machines we use diagrams such as done in \emphasize{UML} \cite{UML2}. There are several ways a starting state can be drawn as seen in figure \ref{fig:state_moore_mealy}.
...
The syntax shown in figure \ref{fig:state_uml_light} is a \emphasize{UML2 State Machine Diagram} \cite{UML2}. \emphasize{UML2 State Machine Diagram} \cite{UML2}. Each state bubble in  \emphasize{UML2 State Machine Diagram} \cite{UML2} contains the information defined by definition \ref{def:uml2} and shown in Figure \ref{fig:state_uml2}. The additional information makes UML2 more useful for representing programs more conveniently.
