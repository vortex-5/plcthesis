...
A \emphasize{Finite State Machines}\cite{booth} defined as a diagram describing the behaviour of a discrete system. Such systems are finite state machines. 
