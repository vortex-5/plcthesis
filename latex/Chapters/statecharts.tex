...
Mathematically a state chart is defined as $M = \lbrace Q, \Sigma, Z, Y, \Delta, q_0\rbrace$
...
\begin{itemize}
	...
	\item $\Sigma$: Set of input symbols.
	\item Z: Set of output symbols.
	\item Y: An output function: $\Sigma \times Q \rightarrow Z$
	\item $\Delta$: A state transition function: $\Sigma \times Q \rightarrow Q$. 
