...
Mathematically a state chart can be defined as $M = \lbrace Q, \Sigma, G, Z, Y, \delta, q_0\rbrace$
...
\begin{itemize}
	...
	\item \textbf{G:} Set of guard functions $\Sigma \times \Sigma \rightarrow Boolean$.
	\item \textbf{Z:} Set of output symbols
	\item \textbf{Y:} A set of functions output functions: $\Sigma \times Q \rightarrow Z$
