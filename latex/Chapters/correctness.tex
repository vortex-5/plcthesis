...
The store block is used for basic assignments. Similar to the input and output examples above the store block generates code that slightly differs from the diagram. First ``:='' is also replaced with ``='' as before where it occurs.
