...
The reader will note that we did not change any of the transitions from figure \ref{fig:correctness_ex_delay}. Dispite this the BLUID's are still different. It shouldn't be too difficult for the reader at this point to prove to themselves that the "goto" routing structure still behaves the same way dispite having different labels.
