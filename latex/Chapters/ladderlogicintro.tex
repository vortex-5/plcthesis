...
All ladder logic programs are built off these basic primitives in addition each manufacturer offers their own convinence functions and additional blocks that allow operations like add subtract to be done in one block rather than attempt to formulate it through the circuit diagram.
