...
\begin{itemize}
	...
	\item \textbf{TTL Input Module:} Allows reading inputs from TTL\gloassary{name={TTL}, description={Transistor-transistor logic}} devices such as most integrated circuits.
\end{itemize}
